...
define(['base'],function(base){
  var routerAppSer = angular.module('RouterServices',[]);
    ...
    // 静态img资源
    routerAppSer.factory('goodsInfoFactory',function(){
       // 首页，头部3个活动商品tab选项卡
       var goodsInfo = {};
       goodsInfo.topTabGoodsBg = [
            {   'src_orange' : './images/tab-bg-orange.png',
                'src_red' : './images/tab-bg-red.png', 'price' : '2500',
                'tab_id' : '0', 'tab_name' : '瘦脸针'},
            {   'src_orange' : './images/tab-bg-orange.png','price' : '5000',
                'src_red' : './images/tab-bg-red.png',
                'tab_id' : '1', 'tab_name' : '水光针'},
            {   'src_orange' : './images/tab-bg-orange.png', 'price' : '300',
                'src_red' : './images//tab-bg-red.png',
                'tab_id' : '2', 'tab_name' : '激光脱毛'}
        ];
        // 首页，底部3个活动背景图
        goodsInfo.actBgSrc = [
            {'src' : './images/shou-lian-zhen-bg.jpg',
                'src_id' : '0','produce_id':'55','sku' : '201605301406412130'},
            {'src' : './images/shui-guang-zhen-bg.jpg',
                'src_id' : '1','produce_id':'56','sku' : '201605301409248893'},
            {'src' : './images/tuo-mao.jpg',
                'src_id' : '2','produce_id':'57','sku' : '201605301528039215'}
        ];
        // 倒计时页面，3个活动top的背景
        goodsInfo.actTopBgSrc = [
            {'src' : './images/shou-lian-zhen-top1.jpg','src_id' : '0', 'price' : '2500',
                'produce_id':'55','sku' : '201605301406412130','actName' : '瘦脸针'},
            {'src' : './images/shui-guang-zhen-top1.jpg','src_id' : '1', 'price' : '5000',
                'produce_id':'56','sku' : '201605301409248893','actName' : '水光针'},
