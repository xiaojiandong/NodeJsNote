 ...
 * value to force the browser into rendering the css defined in the setup (.ng-enter, .ng-leave
 ...
 *      to ensure that the css are applied instantly
    ...
    $provide.decorator('$animate', ['$delegate', '$injector', '$sniffer', '$rootElement', '$$asyncCallback', '$rootScope', '$document',
      ...
      return {
        ...
        */
         ...
         * | 6. $animate scans the element css to get the CSS transition/animation duration and delay                      | class="my-animation ng-animate ng-move"                |
        ...
        */
         ...
         * | 6. $animate scans the element css to get the CSS transition/animation duration and delay        | class="my-animation ng-animate super-add"                        |
        ...
        */
         ...
         * | 6. $animate scans the element css to get the CSS transition/animation duration and delay                                          | class="my-animation ng-animate on on-add on-add-active off-remove off-remove-active" |
